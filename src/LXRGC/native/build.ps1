# build.ps1 - Builds LXRGC.dll (standalone CoreCLR GC) using cl.exe/link.exe directly.
#
# Requires:
...
$linkCmd = "link.exe /nologo /DLL /DEBUG /OUT:`"$outDll`" $($objFiles -join ' ') kernel32.lib advapi32.lib dbghelp.lib"
