...
6. **F / G —** evac-set-scoped remsets with line-reuse tagging + incremental
   time-budgeted evac; parallel RC + array partition.
...
## Changelog
- **2026-07-24** — **E collection-trigger predictors + latency-cliff fix landed → E ✅.**
