...
.SYNOPSIS
    ...
    LXRGC across all benchmarked workloads. Pure inline HTML/CSS/SVG (no
...
<head>
<meta charset="utf-8">
<title>LXRGC vs Workstation vs Server GC - Benchmark Report</title>
<style>
...
<body>
  ...
  <footer>
    LXRGC source: <code>src/LXRGC/native</code> in this repository. Benchmark harness:
    <code>src/LXRGC/run-benchmarks.ps1</code> / <code>generate-report.ps1</code>, using
