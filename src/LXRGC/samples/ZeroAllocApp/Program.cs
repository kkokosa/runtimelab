// LXRGC benchmark app: a (near-)zero-allocation numeric compute workload.
//
...
// whether the GC never collects (LXRGC) or collects normally (Workstation/
...
Console.WriteLine($"# LXRGC-bench ZeroAllocApp starting: duration={durationSeconds}s label={label}");
